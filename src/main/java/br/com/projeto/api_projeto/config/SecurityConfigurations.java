    ...
    public SecurityFilterChain SecurityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/usuario/editar").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.GET, "/usuario/deletar").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.GET, "/usuario/listar_por_tipo").hasAnyRole("ADMIN", "USER")
